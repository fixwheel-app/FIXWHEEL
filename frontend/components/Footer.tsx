        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs md:text-sm">
              <li><Link href="/delhi" className="text-text-secondary hover:text-white transition-colors">Delhi</Link></li>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <a href="https://www.instagram.com/fixwheel.app?igsh=ZDBqZTB1c2tsMWU1" target="_blank" rel="noopener noreferrer"
