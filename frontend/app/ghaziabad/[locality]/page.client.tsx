...
export default function GhaziabadLocalityClientPage({ slug }: LocalityClientProps) {
  ...
  useEffect(() => {
    ...
    getPageVariables('ghaziabad/' + slug, 'ghaziabad').then(setPageVars);
  }, []);
    ...
    <div className={`${slug}-scope ${oswald.variable} ${jetbrains.variable}`}>
      ...
      <section className="hero">
        <div className="wrap hero-grid">
          <div>
            ...
            <h1>Doorstep Bike Repair<br />in <em>{data.name}, Ghaziabad</em></h1>
      ...
      <section className="section-alt">
        <div className="wrap">
          <div className="section-head">
            ...
            <h2>Two Wheeler Mechanic in {data.name}, Ghaziabad</h2>
      ...
      <section className="section-alt">
        <div className="wrap">
          ...
          <CityServicesGrid cityName="Ghaziabad" />
        </div>
      </section>
