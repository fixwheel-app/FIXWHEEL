  ...
  return (
    <div className={`${slug}-scope ${oswald.variable} ${jetbrains.variable}`}>
        ...
        <div className="wrap hero-grid">
          ...
          <div className="live-card">
            ...
            <div className="mech-row">
              <div className="mech-info"><b>Avg. arrival time</b><span>In this area</span></div>
              <div className="mech-eta">{data.eta}</div>
            </div>
            <div className="mech-row">
            ...
            <div className="mech-row">
              <div className="mech-info"><b>Rider rating</b><span>Across this locality</span></div>
              <div className="mech-eta">{data.aggregateRating}★</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-alt">
        <div className="wrap">
          ...
          <div className="trust-strip">
            ...
            <div className="trust-cell"><b>{data.reviewCount}+</b><span>Bikes serviced</span></div>
            <div className="trust-cell"><b>{data.aggregateRating}★</b><span>Rider rating</span></div>
        ...
        <div className="wrap">
          ...
          <div className="why-grid">
            ...
            <div className="why-card">
              ...
              <p>{data.eta} average response time and a 15-day service warranty, applied consistently across {data.name}.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="final-cta" style={{ borderBottom: "none" }}>
        <div className="wrap">
          <h2>Bike repair, right where you are in {data.name}.</h2>
