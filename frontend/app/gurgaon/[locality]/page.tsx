...
const LOCALITIES: Record<string, string> = {
  ...
  "sector-57": "Sector 57",
  "sector-58": "Sector 58",
  "ashok-vihar-phase-3": "Ashok Vihar Phase 3",
...
export default function GurgaonLocalityPage({ params }: { params: { locality: string } }) {
  ...
  // Interlinking: List other localities in Gurgaon
  ...
  const faqs = [
    {
      q: `Do you offer bike repair at home in ${localityName} Gurgaon?`,
  ...
  return (
    <div className="bg-[#151b24] text-white min-h-screen font-sans">
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-5xl">
          <div className="text-center md:text-left space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-accent/10 border border-accent/20 text-accent font-bold uppercase tracking-widest text-[10px]">
              <span>Gurgaon Locality Service</span>
            </div>
            ...
            <div className="text-text-secondary text-sm md:text-base leading-relaxed space-y-4 max-w-3xl">
              <p>
                In a fast-paced corporate hub like Gurgaon, taking time out of your busy schedule to visit a bike garage is the last thing you want to do. FixWheel brings the garage directly to your doorstep in {localityName}, Gurgaon. Our background-checked, expert mechanics arrive at your home or office park to diagnose and repair your two-wheeler on the spot, allowing you to focus on your day without any interruption.
              </p>
              <p>
                From basic scooter servicing to comprehensive motorcycle diagnostics, we handle it all. We serve all sectors in Gurugram, including Golf Course Road, Sohna Road, Palam Vihar, and the DLF phases. Our mechanics carry genuine OEM-grade replacement parts and follow transparent, pre-agreed pricing to ensure a hassle-free experience in {localityName}.
              </p>
              <p>
                Whether your bike is stranded in a basement office parking or sitting in your home garage in {localityName}, booking a doorstep service with FixWheel is the easiest way to get it sorted. Enjoy premium convenience and a 15-day labour warranty on every job.
              </p>
            </div>
            <div className="pt-4">
              <Link 
      ...
      {/* Other Areas We Cover in Gurgaon Section */}
      <section className="py-16 bg-[#151b24] border-b border-white/5">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center md:text-left mb-12">
            <span className="text-xs font-bold uppercase tracking-widest text-accent">Other Localities</span>
            <h2 className="text-2xl md:text-4xl font-black uppercase text-white tracking-tight mt-1">Other Areas We Cover in Gurgaon</h2>
          </div>
