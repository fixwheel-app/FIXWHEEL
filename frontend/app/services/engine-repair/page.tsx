...
export const metadata: Metadata = {
  ...
  description: "Doorstep bike engine diagnostics & repair Delhi NCR. Valve clearance adjustment, clutch plate replacements, starter motor repair.",
  alternates: {
      ...
      <div className="bg-[#17181A] text-white pt-24 pb-16 border-b border-white/10">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tight leading-none mb-6 text-white">
            Bike Engine Repair & Overhaul in Delhi NCR
          </h1>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-5 text-slate-600 text-base md:text-lg leading-relaxed">
              <p>
                Engine knocking, low compression, white smoke, or slipping gears indicate serious mechanical wear.
              </p>
              <p>
                FixWheel's senior mechanics provide doorstep engine diagnostics, valve clearance adjustments, clutch overhaul, and gasket replacements for all major motorcycle & scooter brands in Delhi NCR.
              </p>
            </div>
            <div className="bg-[#F8FAFC] border border-slate-200 rounded-2xl p-6 h-fit space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <span className="text-sm font-bold text-slate-900">15 Days Mechanical Warranty</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F8FAFC] border border-slate-200 rounded-2xl p-8 md:p-10 text-slate-900 relative overflow-hidden mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm font-semibold text-slate-700">Tappet valve clearance setting & timing chain check</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm font-semibold text-slate-700">Clutch plate & friction disc replacement</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm font-semibold text-slate-700">Carburetor cleaning or FI injector pressure scan</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm font-semibold text-slate-700">Spark plug replace & ignition coil voltage check</span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-[#17181A] text-white rounded-2xl p-8 md:p-12 border border-white/10">
            <h2 className="text-2xl md:text-4xl font-black uppercase tracking-tight text-white mb-4">
              Book Engine Diagnostics & Repair
            </h2>
            <p className="text-slate-400 max-w-xl mx-auto mb-8 text-sm md:text-base">
              Get an experienced engine specialist at your doorstep.
            </p>
            <Link
              href="/book"
