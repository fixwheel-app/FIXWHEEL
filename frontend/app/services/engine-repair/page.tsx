...
export const metadata: Metadata = {
  title: "Bike Engine Repair at Doorstep | FixWheel",
  description: "Professional bike engine repair Delhi. Comprehensive diagnostics, clutch plate repairs, and engine overhauls at your doorstep in Delhi NCR.",
  alternates: {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-6">
            Bike Engine Repair Service in Delhi NCR
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="md:col-span-2 space-y-6 text-gray-300 text-base md:text-lg leading-relaxed">
            <p>
              Experiencing loss of power, white smoke, or knocking noises from your motorcycle? FixWheel offers specialized bike engine repair Delhi services. Engine problems are highly complex, and driving with an engine issue can cause severe, irreversible damage.
            </p>
            <p>
              Our master mechanics are trained to perform deep diagnostics and repairs. From replacement of gaskets, clutch plates, and piston rings to a full engine overhaul, we execute standard procedures at your doorstep using only 100% genuine parts.
            </p>
            <p>
              We provide clear upfront estimates before starting any complex engine repair work, ensuring transparency and quality with a service warranty.
            </p>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 text-black shadow-2xl relative overflow-hidden mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm font-semibold text-gray-700">Deep engine diagnostic, compression testing, and noise check</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Gasket replacements and fixing engine oil leaks</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Valve grinding, adjustment, and cylinder head servicing</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Clutch plates and assembly inspection or replacement</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Piston rings, connecting rod, and engine block checks</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Replacement of worn components with genuine spares</span>
            </div>
          </div>
        </div>
