...
export const metadata: Metadata = {
  title: "Scooty Repair at Home | FixWheel",
  description: "Book doorstep scooty repair Delhi. CVT belt adjustments, engine tuning, brake repairs, and oil changes at home for automatic scooters in Delhi NCR.",
  alternates: {
  ...
  openGraph: {
    title: "Scooty Repair at Home | FixWheel",
    description: "Book doorstep scooty repair Delhi. CVT belt adjustments, engine tuning, brake repairs, and oil changes at home for automatic scooters in Delhi NCR.",
    url: "https://www.fixwheel.app/services/scooty-repair",
    siteName: "FixWheel",
    type: "website",
    images: [
      {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="md:col-span-2 space-y-6 text-gray-300 text-base md:text-lg leading-relaxed">
            <p>
              Get convenient, professional scooty repair services right at your doorstep. We service all major gearless scooter models (Activa, Jupiter, Access, Pleasure, Vespa, etc.). From CVT belt replacements to engine tuning, we keep your ride reliable.
            </p>
            <p>
              Our mechanics understand the specific tuning needs of automatic gearless scooters. We clean CVTs to restore smooth acceleration, replace worn rollers, inspect belts, adjust brakes, and replace engine and transmission gear oils.
            </p>
            <p>
              Whether it is a cold-starting issue or high fuel consumption, we diagnose and fix it directly at your home or office.
            </p>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 text-black shadow-2xl relative overflow-hidden mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6 mb-8">
            ...
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">CVT belt inspection and clutch assembly cleaning</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Air filter cleaning or replacement for optimum mileage</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Front and rear brake adjustments and shoe replacement</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Engine oil draining and gear transmission oil replacement</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Front suspension inspection and tyre tread analysis</span>
            </div>
          </div>
        </div>
