...
export const LOCALITY_DB: Record<string, LocalityDetails> = {
  "dwarka": {
    ...
    heroText: "Our mobile bike mechanics cover every sector of Dwarka, from the residential blocks to the busy metro station crossings, responding in under 30 minutes.",
    ...
    reviews: [
      { stars: "★★★★★", text: "Puncture at Dwarka Sec 12 market. The mechanic arrived with the tools and fixed it on the spot in 20 minutes.", who: "Arjun Sharma — Sector 12, Dwarka" },
    ...
    faqs: [
      ...
      { q: "How fast can you reach me in Dwarka?", a: "Average arrival time in Dwarka is 30 minutes, since we have mechanics stationed near Sector 10 and Dwarka Mor." }
    ],
    topServices: [
  ...
  "kapashera": {
    ...
    reviews: [
      { stars: "★★★★★", text: "My bike broke down near Kapashera border. The mechanic came in 30 mins and fixed the ignition coil.", who: "Deepak Yadav — Kapashera Border" },
  ...
  "samalka": {
    ...
    reviews: [
      ...
      { stars: "★★★★★", text: "Excellent diagnostic work. Solved my bike's starting problem in 20 minutes.", who: "Harish Rawat — Samalka Border" }
    ],
    faqs: [
  ...
  "hari-nagar": {
    ...
    heroText: "Get professional bike repair in Hari Nagar at home. Vetted two-wheeler mechanics arrive within 30 minutes to service your motorcycle or scooter.",
  ...
  "najafgarh-road": {
    ...
    reviews: [
      { stars: "★★★★★", text: "Bike stopped starting near Nawada metro station. Mechanic arrived in 25 mins and fixed a wiring short.", who: "Rohan Vashist — Nawada Metro, Najafgarh Road" },
    ...
    faqs: [
      ...
      { q: "What is your typical response time?", a: "Due to our local deployment, average response time is 35 minutes." }
    ],
    topServices: [
  ...
  "palam": {
    ...
    reviews: [
      ...
      { stars: "★★★★★", text: "Mechanic arrived near the station within 30 minutes. Fixed a clutch issue.", who: "Karan Johar — Palam Station Road" }
    ],
    faqs: [
  ...
  "vikaspuri": {
    ...
    reviews: [
      ...
      { stars: "★★★★★", text: "Resolved a starting issue on my bike within 30 minutes of booking. Highly impressed.", who: "Rohit Anand — Block C, Vikaspuri" }
    ],
    faqs: [
  ...
  "bindapur": {
    ...
    faqs: [
      ...
      { q: "How long does an oil change take here?", a: "It takes about 30 minutes. We clean the filter and lube the chain as well." }
    ],
    topServices: [
  ...
  "nawada": {
    ...
    faqs: [
      ...
      { q: "How quickly can a mechanic arrive?", a: "Average arrival time is 30 minutes after booking confirmation." }
    ],
    topServices: [
  ...
  "tilak-nagar": {
    ...
    reviews: [
      ...
      { stars: "★★★★★", text: "My bike broke down near Jail Road. The mechanic arrived in 20 minutes and fixed it.", who: "Dinesh Kalra — Jail Road, Tilak Nagar" }
    ],
    faqs: [
  ...
  "rohini": {
    ...
    reviews: [
      { stars: "★★★★★", text: "Very prompt service in Sector 9. The mechanic fixed a starting problem in 20 minutes.", who: "Rajesh Ranjan — Sector 9, Rohini" },
    ...
    faqs: [
      ...
      { q: "What is your typical response time in Rohini?", a: "Average arrival time in Rohini is 30 minutes, since we have local mobile units stationed in Sector 9." }
    ],
    topServices: [
  ...
  "shalimar-bagh": {
    ...
    faqs: [
      ...
      { q: "What is your average arrival time in Shalimar Bagh?", a: "A mechanic typically reaches Shalimar Bagh locations within 30 minutes." }
    ],
    topServices: [
