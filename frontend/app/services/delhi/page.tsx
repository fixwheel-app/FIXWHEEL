...
export default function DelhiServicesPage() {
  ...
  const areas = [
    "Dwarka", "Vasant Kunj", "Kapashera", "Mahipalpur", "Bijwasan",
    "Rangpuri", "Samalka", "Hari Nagar", "Najafgarh Road", "Palam",
    "Uttam Nagar", "Janakpuri", "Vikaspuri", "Dabri", "Bindapur",
    "Nawada", "Nihal Vihar", "Subhash Nagar", "Tilak Nagar",
    "Rajouri Garden", "Punjabi Bagh", "Ashok Vihar", "Pitampura",
    "Rohini", "Shalimar Bagh", "Paschim Vihar", "Kirti Nagar"
  ];
