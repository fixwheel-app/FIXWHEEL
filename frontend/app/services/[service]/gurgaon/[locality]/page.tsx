...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Book doorstep ${cleanTitle.toLowerCase()} in ${localityData.name}, Gurugram. Fast 45-minute mechanic arrival for all two-wheelers in ${localityData.name} (${localityData.subRegionText}). Transparent pricing, 15-day warranty. FixWheel.`,
    keywords: [
