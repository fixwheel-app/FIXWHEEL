...
export const metadata: Metadata = {
  ...
  description: "Doorstep sports bike service Delhi NCR. Liquid cooling flush, synthetic oil change, chain alignment for Yamaha R15, MT-15, KTM RC, Apache RTR.",
  alternates: {
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-5 text-slate-600 text-base md:text-lg leading-relaxed">
              <p>
                High-revving liquid-cooled motorcycles like Yamaha R15, MT-15, KTM RC 200/390, and TVS Apache RTR 200 need strict maintenance tolerances to deliver full power safely.
              </p>
              <p>
                FixWheel provides doorstep sports bike servicing using full synthetic sport-grade oils, coolant top-ups, radiator fin cleaning, and laser chain alignment across Delhi NCR.
              </p>
            </div>
            <div className="bg-[#F8FAFC] border border-slate-200 rounded-2xl p-6 h-fit space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <span className="text-sm font-bold text-slate-900">15 Days Performance Warranty</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F8FAFC] border border-slate-200 rounded-2xl p-8 md:p-10 text-slate-900 relative overflow-hidden mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm font-semibold text-slate-700">Yamalube/Motul full synthetic sport oil replacement</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm font-semibold text-slate-700">Radiator radiator fins cleaning & coolant level check</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm font-semibold text-slate-700">Precision drive chain cleaning & high-tack lube</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span className="text-sm font-semibold text-slate-700">Front & rear disc brake pad wear inspection</span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-[#17181A] text-white rounded-2xl p-8 md:p-12 border border-white/10">
            <h2 className="text-2xl md:text-4xl font-black uppercase tracking-tight text-white mb-4">
              Book Sports Bike Service Now
            </h2>
            <p className="text-slate-400 max-w-xl mx-auto mb-8 text-sm md:text-base">
              Get an expert performance mechanic at your doorstep.
            </p>
            <Link
              href="/book"
