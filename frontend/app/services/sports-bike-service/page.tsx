...
export const metadata: Metadata = {
  title: "Sports Bike Service at Doorstep | FixWheel",
  description: "Book doorstep sports bike service Delhi. Premium synthetic engine oil changes, radiator coolant service, and ECU diagnostics in Delhi NCR.",
  alternates: {
  ...
  openGraph: {
    title: "Sports Bike Service at Doorstep | FixWheel",
    description: "Book doorstep sports bike service Delhi. Premium synthetic engine oil changes, radiator coolant service, and ECU diagnostics in Delhi NCR.",
    url: "https://www.fixwheel.app/services/sports-bike-service",
    siteName: "FixWheel",
    type: "website",
    images: [
      {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-6">
            Sports Bike Service in Delhi NCR
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="md:col-span-2 space-y-6 text-gray-300 text-base md:text-lg leading-relaxed">
            <p>
              Performance-oriented sports motorcycles require specialized handling and exact specifications. FixWheel provides specialized doorstep sports bike service in Delhi NCR, giving your machine the precision maintenance it needs to run safely and fast.
            </p>
            <p>
              We employ advanced diagnostic scanners, torque wrenches, and only high-performance synthetic lubricants. Our mechanics service the liquid cooling loop, adjust clutch slack, clean performance air filters, and inspect ECU error logs.
            </p>
            <p>
              Whether it is a commuter sport model or a mid-capacity machine, we preserve the responsiveness, throttle feel, and cornering balance of your motorcycle.
            </p>
          </div>
          ...
          <div className="bg-[#1f2631] border border-white/5 rounded-3xl p-6 h-fit space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <span className="block text-xs uppercase tracking-wider text-gray-400">Diagnostics Used</span>
                <span className="text-sm font-bold text-white">Digital OBD scanning and precise torque adjustment tools</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 text-black shadow-2xl relative overflow-hidden mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm font-semibold text-gray-700">Synthetic engine oil refilling and premium filter swap</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Coolant level verification, top-up, and radiator inspection</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Drive chain deep wash, link alignment, and lubrication</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">High-performance disc brake caliper check and pad inspection</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">ECU electronic scanning, sensor diagnostics, and code clearance</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Suspension sag setup check and steering head bearing inspection</span>
            </div>
          </div>
        </div>
