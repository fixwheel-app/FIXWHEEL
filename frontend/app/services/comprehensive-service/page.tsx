...
export const metadata: Metadata = {
  ...
  description: "Get a comprehensive bike service Delhi. 40-point full checkup, carburetor cleaning, cable lube, spark plug swap, and oil change at home in Delhi NCR.",
  alternates: {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="md:col-span-2 space-y-6 text-gray-300 text-base md:text-lg leading-relaxed">
            <p>
              Keep your motorcycle in peak operating condition with FixWheel's comprehensive bike service Delhi packages. Designed for riders who demand ultimate reliability, this package serves as a complete health restoration for your two-wheeler.
            </p>
            <p>
              Our professional mechanics conduct an exhaustive 40-point inspection covering the engine, brakes, cables, fuel lines, suspension, and wheels. We clean the carburetor or fuel injectors, bleed and flush brake fluids, adjust tappet noise, and perform a full oil service.
            </p>
            <p>
              Perfect for preparing your bike for long highway trips or restoring performance on an older machine, this complete package provides peace of mind.
            </p>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 text-black shadow-2xl relative overflow-hidden mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm font-semibold text-gray-700">Complete engine oil replacement and oil filter check</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Carburetor cleaning or fuel injector system diagnostic</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Spark plug replacement and ignition system check</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Brake fluid flushing and caliper piston cleaning</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Lubrication and routing check of clutch, accelerator, and brake cables</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Complete chassis bearing check (cone set, swingarm, wheels)</span>
            </div>
          </div>
        </div>
