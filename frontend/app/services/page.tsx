...
export const metadata: Metadata = {
  ...
  description: "Book doorstep bike repair in Delhi & Gurugram. FixWheel sends verified mechanics to your home or office for bike service, oil change, tyre repair, battery replacement & more. Starting ₹499. Available across Delhi NCR.",
