...
export const metadata: Metadata = {
  ...
  description: "Book doorstep commuter bike service Delhi. Regular oil change, brake adjustments, chain tensioning, and mileage tuning for daily commuter bikes in Delhi NCR.",
  alternates: {
  ...
  openGraph: {
    title: "Commuter Bike Service at Doorstep | FixWheel",
    description: "Book doorstep commuter bike service Delhi. Regular oil change, brake adjustments, chain tensioning, and mileage tuning for daily commuter bikes in Delhi NCR.",
    url: "https://www.fixwheel.app/services/commuter-bike-service",
    siteName: "FixWheel",
    type: "website",
    images: [
      {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-6">
            Commuter Bike Service in Delhi NCR
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="md:col-span-2 space-y-6 text-gray-300 text-base md:text-lg leading-relaxed">
            <p>
              Your daily commuter motorcycle needs to be 100% reliable and fuel-efficient. FixWheel provides specialized doorstep commuter bike service packages across Delhi NCR. We service all popular commuter bikes (Hero Splendor, Honda Shine, TVS Apache, Bajaj Platina, Pulsar, etc.).
            </p>
            <p>
              Our quick on-site tuning is optimized for daily city driving. We replace engine oil, clean air filters and spark plugs, adjust drum and disc brakes, clean and lubricate the drive chain, and run full electrical checks.
            </p>
            <p>
              Get maximum mileage and smooth riding on busy city roads. Skip the visit to local garages and let us tune your vehicle at home or office.
            </p>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 text-black shadow-2xl relative overflow-hidden mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm font-semibold text-gray-700">Draining and refilling of fresh engine oil</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Spark plug cleaning, gap adjustment, and inspection</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Air filter cleaning or replacement for high fuel economy</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Drive chain cleaning, tightening, and lubrication</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Front and rear brake inspection, adjustment, and cleaning</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Alternator charging system check and wiring inspection</span>
            </div>
          </div>
        </div>
