...
export const metadata: Metadata = {
  title: "Electric Scooter Repair at Your Doorstep | FixWheel",
  description: "Book doorstep electric scooter repair Delhi. Expert diagnostics, battery BMS checks, hub motor repairs, and controller servicing at home in Delhi NCR.",
  alternates: {
  ...
  openGraph: {
    title: "Electric Scooter Repair at Your Doorstep | FixWheel",
    description: "Book doorstep electric scooter repair Delhi. Expert diagnostics, battery BMS checks, hub motor repairs, and controller servicing at home in Delhi NCR.",
    url: "https://www.fixwheel.app/services/electric-scooter-repair",
    siteName: "FixWheel",
    type: "website",
    images: [
      {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="md:col-span-2 space-y-6 text-gray-300 text-base md:text-lg leading-relaxed">
            <p>
              Keep your EV running efficiently with FixWheel's dedicated doorstep electric scooter repair services in Delhi NCR. Modern electric scooters require specialized training and tools to safely diagnose battery management systems, hub motors, and controller logic.
            </p>
            <p>
              Our EV-trained technicians carry advanced testing equipment to diagnose and repair electrical faults, wiring harnesses, brake systems, and suspension components, ensuring your electric scooter remains reliable and safe for your daily commute.
            </p>
            <p>
              Enjoy the convenience of having your electric vehicle serviced right at your doorstep, avoiding the hassle of towing it to specialized workshops.
            </p>
          </div>
          ...
          <div className="bg-[#1f2631] border border-white/5 rounded-3xl p-6 h-fit space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <span className="block text-xs uppercase tracking-wider text-gray-400">EV Diagnostics</span>
                <span className="text-sm font-bold text-white">Expert technicians equipped with digital voltage & load analyzers</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 text-black shadow-2xl relative overflow-hidden mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm font-semibold text-gray-700">Battery pack diagnostics and BMS health scanning</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Hub motor inspection, winding test, and electrical wiring scan</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Regenerative braking system adjustment and brake pad replacement</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Speed controller verification and throttle accelerator diagnostic</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Complete check of console display, horns, and LED headlamps</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Suspension inspection, steering column check, and chassis alignment</span>
            </div>
          </div>
        </div>
