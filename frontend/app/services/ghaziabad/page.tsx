...
export const metadata: Metadata = {
  title: "Bike Repair at Home in Ghaziabad | FixWheel",
  description: "Doorstep bike repair in Ghaziabad. Verified mechanics at your home across Indirapuram, Vaishali, Raj Nagar, Kaushambi & all Ghaziabad areas. Starting ₹499.",
  alternates: {
    canonical: "https://www.fixwheel.app/services/ghaziabad",
  },
};

export default function GhaziabadServicesPage() {
  ...
  const areas = [
    ...
    "Raj Nagar", "Vasundhara", "Crossings Republik", "Abhay Khand",
    "Nyay Khand", "Shakti Khand", "Ahinsa Khand", "Shipra Suncity",
    "Govindpuram", "Loni", "Mohan Nagar", "Sanjay Nagar", "Vijay Nagar",
    "Gandhi Nagar", "Shastri Nagar", "Nehru Nagar", "Surya Nagar",
    "Dilshad Garden border", "NH-24", "GT Road", "Hindon", "Dasna"
  ];

  const faqs = [
    {
      q: "Do you offer bike repair at home in Ghaziabad?",
      a: "Yes, we cover Indirapuram, Vaishali, Kaushambi, Raj Nagar and all major Ghaziabad areas."
    },
    {
      q: "Is doorstep bike service available in Indirapuram?",
      a: "Yes, Indirapuram is one of our most active service zones in Ghaziabad."
    },
    {
      q: "How much does bike service cost at home in Ghaziabad?",
      a: "Bike service at home in Ghaziabad starts from ₹499 based on bike type and service package."
    },
    {
      q: "Can I get emergency bike repair in Ghaziabad?",
      a: "Yes, emergency roadside assistance is available 24/7 across all Ghaziabad areas."
    }
  ];
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-5xl">
          <div className="text-center md:text-left space-y-6">
            ...
            <h1 className="text-3xl md:text-6xl font-black uppercase tracking-tight text-white leading-tight">
              Doorstep Bike Repair Service in <span className="text-accent">Ghaziabad</span>
            </h1>
            <div className="text-text-secondary text-sm md:text-base leading-relaxed space-y-4 max-w-3xl">
              ...
              <p>
                Our coverage spans across Indirapuram, Vaishali, Vasundhara, and Raj Nagar Extension. Our verified mechanics are skilled in servicing all scooter and motorcycle brands, utilizing genuine parts and transparent pricing structures to ensure complete peace of mind.
              </p>
              <p>
      ...
      <section className="py-16 bg-[#151b24] border-b border-white/5">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center md:text-left mb-12">
            ...
            <h2 className="text-2xl md:text-4xl font-black uppercase text-white tracking-tight mt-1">Why Choose Us in Ghaziabad</h2>
          </div>
      ...
      <section className="py-16 bg-[#151b24] border-b border-white/5">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center md:text-left mb-12">
            ...
            <h2 className="text-2xl md:text-4xl font-black uppercase text-white tracking-tight mt-1">Areas We Cover in Ghaziabad</h2>
          </div>
