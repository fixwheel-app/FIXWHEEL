...
export const metadata: Metadata = {
  title: "Bike Oil Change at Home | FixWheel",
  description: "Get a professional bike oil change Delhi. Fast, doorstep oil and filter replacement by expert mechanics in Delhi NCR.",
  alternates: {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-6">
            Bike Oil Change Service at Your Doorstep in Delhi NCR
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="md:col-span-2 space-y-6 text-gray-300 text-base md:text-lg leading-relaxed">
            <p>
              Keep your engine running at peak efficiency and temperature with FixWheel's premium bike oil change Delhi services. Over time, engine oil degrades, leading to increased friction, poor mileage, and engine wear.
            </p>
            <p>
              Our professional mechanics carry high-quality, manufacturer-approved engine oil and filters directly to your location. We handle the drainage and disposal of old oil cleanly and quickly, followed by refilling fresh oil matching your vehicle model.
            </p>
            <p>
              By replacing your oil on schedule, you prevent major repairs and ensure a smooth, noise-free riding experience.
            </p>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 text-black shadow-2xl relative overflow-hidden mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm font-semibold text-gray-700">Old engine oil draining and eco-friendly disposal</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Refilling with premium, authentic-grade engine oil</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Oil filter inspection and replacement (if required)</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Spark plug inspection, testing, and cleaning</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Drive chain check, adjustment, and lubrication</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Visual check for oil leaks and engine seal inspection</span>
            </div>
          </div>
        </div>
