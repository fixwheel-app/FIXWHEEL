...
export const metadata: Metadata = {
  title: "Bike Washing & Cleaning at Home | FixWheel",
  description: "Get professional bike washing service Delhi. Doorstep foam wash, engine degreasing, and chain polishing in Delhi NCR.",
  alternates: {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-6">
            Bike General Washing Service at Your Doorstep in Delhi NCR
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="md:col-span-2 space-y-6 text-gray-300 text-base md:text-lg leading-relaxed">
            <p>
              Keep your bike looking showroom-new and prevent structural rust with FixWheel's professional bike washing service Delhi NCR packages. Dust, grime, and road chemicals can corrode metals and damage paint if not washed off properly.
            </p>
            <p>
              We bring high-pressure washing systems and premium cleaning shampoos directly to your doorstep. Our mechanics clean hard-to-reach areas around the engine and underbody, clean the drive chain, and apply protective polish and wax to protect your paint.
            </p>
            <p>
              A clean bike is easier to inspect and runs cooler. Let us restore your two-wheeler's shine while you relax at home.
            </p>
          </div>
          ...
          <div className="bg-[#1f2631] border border-white/5 rounded-3xl p-6 h-fit space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <span className="block text-xs uppercase tracking-wider text-gray-400">Products Used</span>
                <span className="text-sm font-bold text-white">Premium pH-balanced formulas & microfiber detailing cloths</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 text-black shadow-2xl relative overflow-hidden mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm font-semibold text-gray-700">Deep high-pressure water rinse to loosen stuck dirt</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Active foam wash using premium, pH-balanced motorcycle shampoo</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Engine area and underbody degreasing and cleaning</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Drive chain deep cleaning and re-lubrication with premium chain lube</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Paint wax and polish application for protection and gloss</span>
            </div>
            <div className="flex items-start gap-3">
              <Check className="w-5 h-5 text-status-success flex-shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-gray-700">Mirror and dashboard detailing and drying using microfiber cloths</span>
            </div>
          </div>
        </div>
