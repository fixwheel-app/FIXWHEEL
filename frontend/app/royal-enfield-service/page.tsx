...
export const metadata: Metadata = {
  ...
  description:
    "Doorstep Royal Enfield service Delhi NCR. Tappet valve adjustment, 15W50 oil swap, chain lube, clutch overhaul for Classic 350, Bullet, Hunter, Himalayan in Gurgaon, Delhi, Noida.",
  alternates: {
  ...
  openGraph: {
    type: "website",
    title: "Royal Enfield & Bullet Service at Home | FixWheel",
    description: "Doorstep Royal Enfield service Delhi NCR. Certified RE mechanics, 45-min arrival, 15-day warranty.",
