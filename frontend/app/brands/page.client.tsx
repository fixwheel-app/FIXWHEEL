  ...
  return (
    <div className={`brands-scope ${oswald.variable} ${jetbrains.variable}`}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .brands-scope .faq-q .plus {
          font-family: var(--font-jetbrains), monospace;
          color: var(--accent);
          font-size: 18px;
          transition: transform 0.2s ease;
        }
        .brands-scope .faq-item.open .plus {
        ...
        .brands-scope .faq-item.open .faq-a {
          max-height: 300px;
        }
        .brands-scope .faq-a p {
          padding-bottom: 22px;
          color: #475569;
          font-size: 14.5px;
          max-width: 760px;
        ...
        /* ===== PARTNER CTA ===== */
        .brands-scope .partner {
          display: grid;
          grid-template-columns: 1.3fr 1fr;
          gap: 50px;
          align-items: center;
        }
        .brands-scope .partner ul {
          margin-top: 20px;
          display: flex;
          flex-direction: column;
          gap: 10px;
        }
        .brands-scope .partner li {
          font-size: 14.5px;
          color: var(--ink-dark);
          display: flex;
          gap: 10px;
        ...
        .brands-scope .partner li::before {
          content: "—";
          color: var(--accent);
        }
        .brands-scope .partner-box {
          background: #0F172A;
        ...
        .brands-scope .contact-grid {
          display: grid;
          grid-template-columns: 1fr 1fr;
          gap: 60px;
        }
        .brands-scope .contact-list {
          display: flex;
          flex-direction: column;
          gap: 22px;
          margin-top: 20px;
        }
        .brands-scope .contact-item {
          display: flex;
          gap: 16px;
          align-items: flex-start;
        }
        .brands-scope .contact-item .ic {
          width: 38px;
          height: 38px;
        ...
        .brands-scope .contact-item b {
          display: block;
          color: var(--ink-dark);
          font-size: 15px;
          margin-bottom: 2px;
        }
        .brands-scope .contact-item span {
          color: #64748B;
          font-size: 13.5px;
        }
              ...
              {filteredBrands.map((brand, idx) => (
                <div className="brand-card" key={idx}>
                  ...
                  <div className="brand-card-cta" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
                    ...
                    <Link href={`/${brand.name.toLowerCase().replace(/ /g, "-")}`} style={{ color: 'var(--ink-dim)', fontSize: '11px', transition: 'color 0.15s' }} className="hover-white">Models & Info →</Link>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* ===== BRAND FAQS (LOCALITY THEME) ===== */}
      <section id="faq" className="faq-section">
        <div className="wrap">
          <div className="section-head" style={{ marginBottom: "40px" }}>
            <div className="eyebrow">FAQS</div>
            <h2>Common questions about doorstep brand servicing</h2>
          </div>
      ...
      <section id="contact" className="section-alt" style={{ borderTop: "1px solid var(--line-paper)", borderBottom: "1px solid var(--line-paper)", padding: "88px 0" }}>
        <div className="wrap contact-grid">
          <div>
            ...
            <h2>Contact us</h2>
            <p style={{ color: "var(--ink-dim)", marginTop: "10px" }}>Have a question about bike or scooter service? We are available from 8 AM to 8 PM.</p>
      ...
      <section className="keywords-section" style={{ padding: "60px 0", borderBottom: "1px solid var(--line-paper)" }}>
        <div className="wrap">
