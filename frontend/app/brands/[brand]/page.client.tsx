          ...
          <div className="hero-grid">
            <div className="hero-inner">
              ...
              <div className="hero-ctas">
                <Link href={`/book?brand=${brandSlug}#${brandSlug}`} className="btn btn-primary">
            ...
            <div className="hero-snapshot-card">
              ...
              <div className="hero-snapshot-foot">
                <Link href={`/book?brand=${brandSlug}#${brandSlug}`} className="btn btn-primary" style={{ width: "100%", justifyContent: "center" }}>
              ...
              return (
                <div className="cc-price-card" key={idx}>
                  ...
                  <div className="cc-price-card-foot">
                    ...
                    <Link
                      href={`/book?brand=${brandSlug}#${brandSlug}`}
        ...
        <div className="wrap contact-grid">
          ...
          <div className="sos-highlight-box" style={{
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "10px" }}>
              <Link href={`/book?brand=${brandSlug}#${brandSlug}`} className="btn btn-primary" style={{ padding: "10px 20px", fontSize: "12px" }}>
