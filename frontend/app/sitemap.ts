...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const serviceRoutes: MetadataRoute.Sitemap = dynamicServices.map((service) => {
    ...
    const isRootLevelRoute = service.slug === "gurgaon" || service.slug.startsWith("gurgaon/") || service.slug === "noida" || service.slug.startsWith("noida/") || service.slug === "faridabad" || service.slug.startsWith("faridabad/") || service.slug === "ghaziabad";
