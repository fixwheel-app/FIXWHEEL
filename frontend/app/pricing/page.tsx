...
export const metadata: Metadata = {
  ...
  description: "View upfront, transparent pricing for doorstep bike service, engine oil change, brake repairs, and roadside assistance across Delhi.",
  alternates: {
    canonical: "https://www.fixwheel.app/pricing",
  },
  openGraph: {
    title: "Doorstep Bike Service Rates & Official Rate Card | FixWheel",
    description: "Transparent doorstep bike service charges across Delhi, Gurgaon, Noida, Ghaziabad & Faridabad. Zero hidden costs.",
