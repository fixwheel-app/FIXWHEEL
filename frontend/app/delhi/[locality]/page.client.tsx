...
export default function DelhiLocalityClientPage({ slug }: LocalityClientProps) {
  ...
  useEffect(() => {
    ...
    getPageVariables('delhi/' + slug, 'delhi').then(setPageVars);
  }, []);
  ...
  return (
    <div className={`${slug}-scope ${oswald.variable} ${jetbrains.variable}`}>
      ...
      <div className="crumb" style={{ background: "#111214", borderBottom: "1px solid rgba(255,255,255,0.08)", padding: "12px 0" }}>
        <div className="wrap">
          <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Delhi", href: "/delhi" }, { label: data.name }]} />
        </div>
      </div>
      ...
      <section className="hero">
        <div className="wrap hero-grid">
          <div>
            ...
            <h1>Doorstep Bike Repair<br />in <em>{data.name}, Delhi</em></h1>
      ...
      <section className="section-alt">
        <div className="wrap">
          <div className="section-head">
            ...
            <h2>Two Wheeler Mechanic in {data.name}, Delhi</h2>
