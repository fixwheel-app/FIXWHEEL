        ...
        <div className="wrap hero-grid">
          <div>
            ...
            <div className="stat-row">
              ...
              <div className="stat"><b>300+</b><span>Bikes serviced</span></div>
              <div className="stat"><b>4.6★</b><span>Customer rating</span></div>
          ...
          <div className="ticket">
            ...
            <div className="ticket-rows">
              ...
              <div className="r"><label>Response</label><div>42 min</div></div>
            </div>
      ...
      <section id="areas" className="section-alt">
        <div className="wrap">
          ...
          <div className="area-grid">
            ...
            <Link href="/delhi/najafgarh" className="area-tag">📍 Najafgarh</Link>
            ...
            <Link href="/delhi/moti-nagar" className="area-tag">📍 Moti Nagar</Link>
            <Link href="/delhi/naraina" className="area-tag">📍 Naraina</Link>
            <Link href="/delhi/mayapuri" className="area-tag">📍 Mayapuri</Link>
            <Link href="/delhi/saket" className="area-tag">📍 Saket</Link>
            <Link href="/delhi/hauz-khas" className="area-tag">📍 Hauz Khas</Link>
            <Link href="/delhi/malviya-nagar" className="area-tag">📍 Malviya Nagar</Link>
            <Link href="/delhi/mehrauli" className="area-tag">📍 Mehrauli</Link>
            <Link href="/delhi/chattarpur" className="area-tag">📍 Chattarpur</Link>
            <Link href="/delhi/sainik-farm" className="area-tag">📍 Sainik Farm</Link>
            <Link href="/delhi/greater-kailash" className="area-tag">📍 Greater Kailash</Link>
            <Link href="/delhi/lajpat-nagar" className="area-tag">📍 Lajpat Nagar</Link>
      ...
      <section>
        <div className="wrap">
          <div className="section-head">
            ...
            <p style={{ marginTop: '10px' }}><b style={{ color: 'var(--paper)', fontSize: '18px' }}>4.6★</b> average rating from <b style={{ color: 'var(--paper)' }}>89 reviews</b></p>
          </div>
