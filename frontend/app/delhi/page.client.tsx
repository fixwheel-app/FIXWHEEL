...
export default function DelhiClientPage() {
  ...
  const [stats, setStats] = useState<PublicStatRecord>(DEFAULT_PUBLIC_STATS.delhi || DEFAULT_PUBLIC_STATS.global);

  useEffect(() => {
    getPublicStatsForCity('delhi').then(setStats);
    getPageVariables('delhi', 'delhi').then(setPageVars);
  }, []);
    ...
    <div className={`delhi-scope ${oswald.variable} ${jetbrains.variable}`}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (max-width: 900px){
          ...
          .delhi-scope .wrap { padding: 0 16px !important; }
          .delhi-scope .hero h1 { font-size: 24px !important; line-height: 1.2 !important; word-break: break-word !important; overflow-wrap: break-word !important; }
          .delhi-scope .hero-ctas { flex-direction: column !important; width: 100% !important; gap: 10px !important; }
          .delhi-scope .btn { width: 100% !important; justify-content: center !important; text-align: center !important; padding: 12px 16px !important; font-size: 12px !important; white-space: normal !important; word-break: break-word !important; }
      ...
      <div style={{ background: "#111214", borderBottom: "1px solid rgba(255,255,255,0.08)", padding: "12px 0" }}>
        <div className="wrap">
          <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Delhi" }]} />
        </div>
      </div>
      ...
      <section className="section-alt">
        <div className="wrap">
          ...
          <CityServicesGrid cityName="Delhi" />
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="faq-list">
            ...
            <div className={`faq-item ${openFaqs[1] ? "open" : ""}`}>
              ...
              <div className="faq-a"><p>Basic service starts from ₹550 depending on your bike model and cc. We confirm the exact price before starting any work.</p></div>
            </div>
      ...
      <section className="final-cta" style={{ borderBottom: "none" }}>
        <div className="wrap">
          ...
          <p>Verified mechanic at your home or office across South & South-West Delhi. Starting ₹550. No garage visit needed.</p>
