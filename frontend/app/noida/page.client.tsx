...
import { NoidaSections } from "@/components/city/noida/NoidaSections";
  ...
  return (
    <div className={`noida-scope ${oswald.variable} ${jetbrains.variable}`}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .noida-scope .svc-grid::-webkit-scrollbar {
          height: 6px !important;
        }
        .noida-scope .svc-grid::-webkit-scrollbar-track {
          background: #E2E8F0 !important;
          border-radius: 4px !important;
        }
        .noida-scope .svc-grid::-webkit-scrollbar-thumb {
      ...
      <NoidaSections pageVars={pageVars} stats={stats} openFaqs={openFaqs} toggleFaq={toggleFaq} />
    </div>
  );
}
