  ...
  return (
    <div className={`noida-scope ${oswald.variable} ${jetbrains.variable}`}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .noida-scope .why-card p { font-size: 14px; color: rgba(255, 255, 255, 0.7); }
        ...
        .noida-scope .svc-card p { font-size: 13.5px; color: rgba(255, 255, 255, 0.7); margin-bottom: 16px; min-height: 58px;}
        ...
        .noida-scope .svc-price span { font-size: 11px; font-weight: 400; color: rgba(255, 255, 255, 0.5); letter-spacing: 0.04em; }
        ...
        .noida-scope .review p { font-size: 14.5px; margin-bottom: 18px; color: #3C3D40; }
        ...
        .noida-scope .faq-a p { padding-bottom: 22px; color: #3C3D40; font-size: 14.5px; max-width: 760px; }
        ...
        .noida-scope .final-cta p { color: #3C3D40; margin-bottom: 32px;}
