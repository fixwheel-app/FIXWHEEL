          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl border border-gray-100 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.05)] p-6 md:p-12 prose prose-gray max-w-none">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                The Terms of Use laid down herein (referred to as <strong>“Terms”</strong>) as uploaded on <Link href="/" className="text-accent hover:underline">https://fixwheel.app/</Link> shall govern the usage, rights and liabilities of <strong>FIXWHEEL PRIVATE LIMITED</strong> (hereinafter referred to as “Company”/ “FIXWHEEL”/ “We”/ “Us” or “Our”) and the User (<strong>“You / User”</strong>) while accessing and using the FIXWHEEL website and mobile application as defined below.
              </p>

              <p className="text-gray-600 leading-relaxed mb-8">
                <strong>FIXWHEEL</strong> is the brand / mark of <strong>FIXWHEEL PRIVATE LIMITED</strong>. Through its platform <Link href="/" className="text-accent hover:underline">https://fixwheel.app/</Link> the Company is engaged in the business of doorstep maintenance and repair services including but not limited to servicing, cleaning, check-up, dry wash, etc. of two wheeler vehicles.
              </p>
